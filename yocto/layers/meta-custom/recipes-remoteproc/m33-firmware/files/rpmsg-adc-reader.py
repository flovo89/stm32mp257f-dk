...
Current channel assignments (external GPIO on expansion header CN13):
  ch0 = ADC3_INP3   PG3  →  connect external voltage for non-zero readings
  ch1 = ADC3_INP12  PC3  →  connect external voltage for non-zero readings
